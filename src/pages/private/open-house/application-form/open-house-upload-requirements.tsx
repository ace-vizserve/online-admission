...
import ParentGuardianUpload from "@/components/private/open-house/steps/upload-requirements/parent-guardian-upload";
import StudentUpload from "@/components/private/open-house/steps/upload-requirements/student-upload";
...
function OpenHouseUploadRequirements() {
  ...
  if (formState.enrollmentInfo == null) {
    return <Navigate to={"/open-house/enrollment-info"} />;
  }
...
export default OpenHouseUploadRequirements;
