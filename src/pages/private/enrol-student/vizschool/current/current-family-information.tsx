...
import FatherInformation from "@/components/private/enrol-student/vizschool/tabs/family-information/father-information";
import GuardianInformation from "@/components/private/enrol-student/vizschool/tabs/family-information/guardian-information";
import MotherInformation from "@/components/private/enrol-student/vizschool/tabs/family-information/mother-information";
import SiblingInformation from "@/components/private/enrol-student/vizschool/tabs/family-information/sibling-information";
...
function CurrentFamilyInformation() {
...
function FamilyInformationTabs() {
  ...
  const { setFormState, formState } = useEnrolCurrentLearnerContext();
  const { data, isPending, isSuccess, fetchStatus } = useQuery({
    queryKey: ["current-learner-family-information", params.id],
    queryFn: async () => {
  ...
  useEffect(() => {
    ...
    setFormState({
      familyInfo: { ...data! } as unknown as VizSchoolEnrolOldStudentFormState["familyInfo"],
    });
...
export default CurrentFamilyInformation;
