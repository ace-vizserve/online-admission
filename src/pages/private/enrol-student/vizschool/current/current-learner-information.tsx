...
import LearnerAddressContact from "@/components/private/enrol-student/vizschool/tabs/learner-information/learner-address-contact";
import LearnerDetails from "@/components/private/enrol-student/vizschool/tabs/learner-information/learner-details";
...
const tabs = [
  ...
  },
  {
    ...
    icon: MapPin,
    component: LearnerAddressContact,
  },
];

function CurrentLearnerInformation() {
  ...
  const { data, isSuccess, isPending, fetchStatus } = useQuery({
    queryKey: ["learner-information", params.id],
    queryFn: async () => {
  ...
  useEffect(() => {
    ...
    setFormState({
      studentInfo: data?.studentInfo as VizSchoolEnrolOldStudentFormState["studentInfo"],
    });
...
export default CurrentLearnerInformation;
