...
function EnrollmentInformation() {
  ...
  function onSubmit(values: EnrollmentInformationSchema) {
    ...
    // has not answered (setError keeps isSubmitSuccessful false, so the step does not advance).
  ...
  const incompleteStepUrl = firstIncompleteStepUrl(formState, "hfse-is", "enrollmentInfo");
                        ...
                        <Select
                          ...
                          <SelectContent>
                            <ScrollArea className="h-52">
                              {levelOptions(admissionOptions.derived).map((level) => (
