...
function FamilyInformationTabs() {
  ...
  // Sends the parent to the earliest step whose data is incomplete, so a step can never be
  // rendered on top of unmet prerequisites. Validity-based: the old presence check was
  // satisfied by a slice the autosave created on the first keystroke.
  const incompleteStepUrl = firstIncompleteStepUrl(formState, "hfse-is", "familyInfo");
