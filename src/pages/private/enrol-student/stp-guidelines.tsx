...
function STPGuidelines() {
  ...
  return (
    <>
      ...
      <MaxWidthWrapper className="animate-in fade-in slide-in-from-bottom-2 duration-500 mt-16 mb-24 relative w-full min-h-screen">
        ...
        <section className="mx-auto py-12">
          <div className="rounded-3xl bg-gradient-to-br from-slate-50 to-amber-50/30 border border-slate-200 p-6 md:p-10 shadow-sm space-y-12">
            {/* 1. Header & Info Grid */}
              ...
              {preCourseAnswer === "No" && (
                <div className="flex flex-col gap-3 p-5 rounded-xl bg-amber-50 border border-amber-200 text-amber-700 shadow-sm animate-in fade-in slide-in-from-top-2">
                  ...
                  <p className="font-medium text-sm leading-relaxed">
                    ...
                    You can continue with the online enrolment now, but the counselling must be completed and
                    acknowledged before your child begins the course.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="text-center space-y-6 pt-6">
              <Button
                ...
                className="text-xs lg:text-sm h-12 lg:!h-16 !px-8 lg:!px-12 rounded-2xl font-black uppercase tracking-widest">
                Continue to Application Form
                <ArrowRight className="ml-3 size-4 stroke-3" />
              </Button>
