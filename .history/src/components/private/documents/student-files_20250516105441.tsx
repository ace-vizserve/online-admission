...
function StudentFiles({ studentID }: ProfileProps) {
  const { data, isPending } = useQuery({
    queryKey: ["documents-profile", studentID],
    queryFn: async () => {
...
function InfoBox({ label, value, studentDetails }: { label: string; value: string; studentDetails: StudentDetails }) {
  ...
  switch (value) {
    case "student-documents":
      return <StudentDocuments label={label} studentdocuments={studentDocuments} />;
    // case "family-documents":
      return <FamilyDocuments label={label} familyInformation={familyInformation} />;
    // case "guardian-documents":
