...
function SingleDocuments() {
  ...
  if (!data?.studentsDocumentsList) {
    return <NoStudentsPanel />;
  }

    const students = data.studentsDocumentsList.map(student => ({
    id: student.studentID,
    studentName: student.documentOwner,
    documentType: student.documentType,
    status: student.status,
    documentOwnerID: student.documentOwnerID,
...
type StudentsListTableProps = {
  refetch: (options?: RefetchOptions | undefined) => Promise<QueryObserverResult<DocumentsResponse, Error>>;
  isRefetching: boolean;
  studentsList: StudentDocument[];
};
