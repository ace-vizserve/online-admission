...
import { Document, StudentFiles, FamilyDocument } from "@/types";
              ...
              {doc.documentType == "Pass" && (
                <Popover>
                  ...
                  <PopoverContent className="w-72">
                    <div className="grid gap-4">
                      <div className="space-y-1">
                        <h4 className="font-medium text-sm">Mother Pass</h4>
                        <p className="text-xs text-muted-foreground">See the details of the Mother's Pass.</p>
                      </div>
                      <div className="grid gap-2">
                        <div className="grid grid-cols-3 items-center gap-4">
                          <Label htmlFor="passType" className="text-xs">
              ...
              {doc.documentType == "Passport" && (
                <Popover>
                  ...
                  <PopoverContent className="w-72">
                    <div className="grid gap-4">
                      <div className="space-y-1">
                        <h4 className="font-medium text-sm">Mother Passport</h4>
                        <p className="text-xs text-muted-foreground">See the details of the Mother's Passport.</p>
                      </div>
                      <div className="grid gap-2">
                        <div className="grid grid-cols-3 items-center gap-4">
                          <Label htmlFor="passType" className="text-xs">
