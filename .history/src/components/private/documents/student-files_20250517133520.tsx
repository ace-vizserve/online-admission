...
import { Document, StudentDetails } from "@/types";
...
function InfoBox({ label, value, studentDetails }: { label: string; value: string; studentDetails: StudentDetails }) {
  ...
  const studentID = studentDetails.studentInformation[0]?.studentID;
              ...
              <div className="grid gap-4">
                ...
                <div className="grid gap-2">
                  {doc.documentType === "Pass" && (
                    <>
                      <div className="grid grid-cols-3 items-center gap-4">
                        <Label htmlFor="passType" className="text-xs">Pass Type</Label>
                        <Input
                          id="passType"
                          defaultValue={doc.passType?.replace("_", " ") ?? ""}
                          className="col-span-2 h-8 capitalize"
                      ...
                      <div className="grid grid-cols-3 items-center gap-4">
                        <Label htmlFor="passExpirationDate" className="text-xs">Expires at</Label>
                        <Input
                          id="passExpirationDate"
                          defaultValue={formatDate(doc.passExpirationDate!, "PPP")}
                          className="col-span-2 h-8"
                  ...
                  {doc.documentType === "Passport" && (
                    <>
                      <div className="grid grid-cols-3 items-center gap-4">
                        <Label htmlFor="passportNumber" className="text-xs">Passport #</Label>
                        <Input
                          id="passportNumber"
                          defaultValue={doc.passportNumber ?? ""}
                          className="col-span-2 h-8 uppercase"
                      ...
                      <div className="grid grid-cols-3 items-center gap-4">
                        <Label htmlFor="passportExpirationDate" className="text-xs">Expires at</Label>
                        <Input
